            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            <li class="active"><a href="dg.php">Design Gallery</a>
                        ...
                        <ul class="portfolio-items courses list-unstyled" id="grid">
                            <li class="col-sm-6">
                                <figure class="portfolio-item gallery-caption">
                                    <img src="assets/images/gallery/dg7/5.jpg" alt="">
                            ...
                            <li class="col-sm-6">
                                <figure class="portfolio-item gallery-caption">
                                    <img src="assets/images/gallery/dg7/1.jpg" alt="">
                            ...
                            <li class="col-sm-6">
                                <figure class="portfolio-item gallery-caption">
                                    <img src="assets/images/gallery/dg7/3.jpg" alt="">
                            ...
                            <li class="col-sm-6">
                                <figure class="portfolio-item gallery-caption">
                                    <img src="assets/images/gallery/dg7/2.jpg" alt="">
                            ...
                            <li class="col-sm-6">
                                <figure class="portfolio-item gallery-caption">
                                    <img src="assets/images/gallery/dg7/6.jpg" alt="">
                            ...
                            <li class="col-sm-6">
                                <figure class="portfolio-item gallery-caption">
                                    <img src="assets/images/gallery/dg7/4.jpg" alt="">
